...
from circuit_maintenance_parser.parsers.dtag import HtmlParserDTAG
...
class DTAG(GenericProvider):
    """DTAG provider custom class."""

    _processors: List[GenericProcessor] = PrivateAttr(
        [
            CombinedProcessor(data_parsers=[HtmlParserDTAG, ICal]),
        ]
    )
